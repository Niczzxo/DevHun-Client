      ...
      <section className="mt-6 py-8 bg-info/4 dark:bg-info/20">
        <MyContainer className="space-y-9">
          ...
          >
            ...
            <p className="text-base md:text-lg max-w-xl mx-auto">
              DevHun is where world-class talent meets opportunity. We're
              ...
              hire or get hired, DevHun makes it simple, secure, and successful.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-2.5">
                <p>
                  ...
                  DevHun breaks down geographical barriers to bring you the best
                ...
                <p>
                  ...
                  businesses trust DevHun to scale their teams and bring their
                  ideas to life.
                </p>
              </div>
            </motion.div>
        ...
        <MyContainer className="space-y-12">
          ...
          >
            ...
            <p className="text-base md:text-lg max-w-xl mx-auto">
              ...
              talent or looking for your next project, DevHun makes it easy and
              secure.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-base-100 dark:bg-gray-900">
        <MyContainer className="space-y-12">
          ...
          >
            ...
            <p className="text-base md:text-lg max-w-xl mx-auto">
              Real freelancers and clients share how DevHun transformed their
              work and business.
            </p>
          </motion.div>
